...
vim.keymap.set("n", "<c-]>", builtin.lsp_definitions, { desc = "Go to LSP definitions" })
vim.keymap.set("n", "grt", builtin.lsp_type_definitions, { desc = "Go to LSP type definitions" })
vim.keymap.set("n", "grr", builtin.lsp_references, { desc = "Go to LSP references" })
vim.keymap.set("n", "gri", builtin.lsp_implementations, { desc = "Go to LSP implementations" })
